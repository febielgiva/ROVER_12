...
public class COPY___Rover_12Febi {
	...
	public COPY___Rover_12Febi(String serverAddress) {
		// constructor
		System.out.println("ROVER_12 rover object constructed");
		rovername = "ROVER_12";
	...
	public static void main(String[] args) throws Exception {
		COPY___Rover_12Febi client = new COPY___Rover_12Febi();
		client.run();
	}
}