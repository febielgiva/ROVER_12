...
public class RV_12_ks_current_4DEBUG extends ROVER_12 {
	...
	public RV_12_ks_current_4DEBUG() {
		super();
	}

	public RV_12_ks_current_4DEBUG(String serverAddress) {
		super(serverAddress);
	}
	...
	public static void main(String[] args) throws Exception {
		RV_12_ks_current_4DEBUG client = new RV_12_ks_current_4DEBUG();
		client.run();
	}
		...
		for (int j = 0; j < edgeSize; j++) {
			...
			for (int i = 0; i < edgeSize; i++) {
				...
				// check and print edge of map has first priority
					...
					// NOTE: PLEASE REFER TO YOUR STUFF WITH 1 CAPITAL OR SMALL LETTER TO KEEP THE SAME FORMAT
					// IN THIS CASE BECAUSE U HAVE SCIENCE AND TERRAIN REFER TO IT AS "H" OR ANYTHING ELSE WILL WORK -->> AN ADVANCE WAY TO DO IT IS TO HAVE A Specific letter to define what kind of science and terrain is that
