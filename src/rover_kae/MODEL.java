...
public class MODEL {
	...
	public MODEL(String serverAddress) {
		// constructor
		System.out.println(rovername + " rover object constructed");
		rovername = "ROVER_11";
	...
	private void run() throws IOException, InterruptedException {
		...
		while (true) {
			...
			// List<String> moves = search.Astar(currentLoc, destination,
			// scanMapTiles);

			// System.out.println(rovername + "currentLoc: " + currentLoc +
			...
			// System.out.println("Rover near destiation. distance: " +
			// getDistance(currentLoc, destination));
			...
			// TODO: also, what if the destination is already taken? update
			// globalMap and dont go there
			...
			// destination = getClosestDestination(currentLoc);
			// System.out.println("Target blocked. Switch target to: " +
			// destination);
		}
		...
		// "ROVER_11 check connection to server");
		// line = "";
		// }
		// if (line.startsWith("LOC")) {
		// currentLoc = extractLocationFromString(line);
		...
		// System.out.println("ROVER_11 currentLoc after recheck: " +
		// currentLoc);
	...
	private void updateglobalMap(Coord currentLoc, MapTile[][] scanMapTiles) {
		...
		MapTile currentMapTile = scanMapTiles[centerIndex][centerIndex]
				.getCopyOfMapTile();
	...
	private ArrayList<String> getEquipment() throws IOException {
		...
		// System.out.println("ROVER_11 incomming EQUIPMENT result - first readline: "
		// + jsonEqListIn);
	...
	public void doScan() throws IOException {
		...
		System.out.println(rovername
				+ " incomming SCAN result - first readline: " + jsonScanMapIn);
