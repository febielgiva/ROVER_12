...
public class rover12_ks_wk9 {
	...
	public rover12_ks_wk9(String serverAddress) {
		// constructor
		System.out.println("ROVER_12 rover object constructed");
		rovername = "ROVER_12";
...
//					+ currentLoc.ypos + " west is blocked");
	...
	private boolean isTowardsEastIsObsatacle(MapTile[][] scanMapTiles,
		...
		if (scanMapTiles[centerIndex + 1][centerIndex].getHasRover()
			...
			// debug print out
//			System.out.println("x,y=" + (currentLoc.xpos + 1) + ","
//					+ currentLoc.ypos + " east is blocked");
			return true;
		} else {
			// debug print out
//			System.out.println("x,y=" + (currentLoc.xpos + 1) + ","
//					+ currentLoc.ypos + " is open");
			return false;
		}
	}
	...
	private boolean isTowardsNorthIsObsatacle(MapTile[][] scanMapTiles,
		...
		if (scanMapTiles[centerIndex][centerIndex - 1].getHasRover()
			...
			// debug print out
//			System.out.println("x,y=" + (currentLoc.xpos + 1) + ","
//					+ currentLoc.ypos + " north is blocked");
			try {
				Thread.sleep(4000);
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
	...
	private boolean isTowardsSouthIsObsatacle(MapTile[][] scanMapTiles,
		...
		if (scanMapTiles[centerIndex][centerIndex + 1].getHasRover()
			...
			// debug print out
//			System.out.println("x,y=" + (currentLoc.xpos + 1) + ","
//					+ currentLoc.ypos + "south is blocked");
...
//	}
	...
	public static void main(String[] args) throws Exception {
		rover12_ks_wk9 client = new rover12_ks_wk9();
		client.run();
	}
}