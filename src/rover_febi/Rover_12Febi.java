...
public class Rover_12Febi {
	...
	private void run() throws IOException, InterruptedException {
		...
		try {
			...
			// G12 - Febi, this does not pull the locations correctly, so I
			// suggest that you remove it. -ks
			...
			// G12 - Febi, this does not pull the location correctly, so I
			// suggest that you remove it. -ks
						...
						if (scanMapTiles[centerIndex - 1][centerIndex]
							...
							if (scanMapTiles[centerIndex][centerIndex + 1]
								...
								if (scanMapTiles[centerIndex][centerIndex - 1]
									...
									out.println("E");
									System.out
											.println("ROVER_12 request move E");
									goingSouth = false;
									goingEast = true;
									goingNorth = false;
									goingWest = false;
						...
						if (scanMapTiles[centerIndex][centerIndex - 1]
							...
							if (scanMapTiles[centerIndex - 1][centerIndex]
								...
								if (scanMapTiles[centerIndex + 1][centerIndex]
									...
									out.println("MOVE S");
									System.out
											.println("ROVER_12 request move S");
									goingSouth = true;
									goingEast = false;
									goingNorth = false;
									goingWest = false;
