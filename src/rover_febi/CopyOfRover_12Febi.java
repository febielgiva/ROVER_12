...
public class CopyOfRover_12Febi {
	...
	public CopyOfRover_12Febi(String serverAddress) {
		// constructor
		System.out.println("ROVER_12 rover object constructed");
		rovername = "ROVER_12";
	...
	public static void main(String[] args) throws Exception {
		CopyOfRover_12Febi client = new CopyOfRover_12Febi();
		client.run();
	}
}